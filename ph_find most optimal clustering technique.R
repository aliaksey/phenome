...
model.sel.names<-c("Cells_AreaShape_Extent", "Cells_AreaShape_Eccentricity","Cells_AreaShape_Area", 
                   "Cells_RadialDistribution_RadialCV_Actin4Corr_3of4", "Cells_AreaShape_MinorAxisLength")
...
selnames<-list(Simple=simple.cellshape.name,Simple2=simple.2,Simple3=simple.3, Simple4=simple.4,Simple5=simple.5, Zernike=zernike.cellshape.name, Model=model.sel.names)
